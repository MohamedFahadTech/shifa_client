        ...
        <div className="min-h-screen bg-slate-50 flex flex-col">
            ...
            {selections && (
                <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-6">
                    ...
                    <div className="relative bg-white w-full sm:max-w-lg rounded-t-[2.5rem] sm:rounded-[3rem] shadow-2xl overflow-hidden p-8 sm:p-10">
      ...
      {["Normal", "Steam"].map(q => (
        ...
        >
          {q}
            ...
            {cart.length > 0 && (
                <div className="lg:hidden fixed bottom-8 left-[5%] right-[5%] z-40">
                    <button
            ...
            {isMobileBasketOpen && (
                <div className="fixed inset-0 z-50 lg:hidden flex flex-col">
                    ...
                    <div className="relative mt-auto bg-white rounded-t-[3rem] p-8 max-h-[90vh] overflow-y-auto">
...
const BasketContent = ({ cart, removeFromCart, totalAmount, setStep }) => (
...
const CheckoutForm = ({ cart, totalAmount, onComplete, onBack }) => {
    ...
    return (
        <div className="max-w-2xl mx-auto p-8 bg-white rounded-[3rem] shadow-2xl border border-slate-100 my-10">
            <button onClick={onBack} className="text-slate-400 font-black text-xs uppercase tracking-widest mb-6 hover:text-blue-600">
                ← Back to Items
            </button>
...
const SuccessScreen = () => (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-8 text-center">
        ...
        <p className="text-slate-400 font-bold mb-12">Our team is on the way to pick up your laundry.</p>
        <button onClick={() => window.location.reload()} className="w-full max-w-sm bg-slate-900 text-white py-6 rounded-[2rem] font-black uppercase tracking-widest">
            Continue Shopping
        </button>
    </div>
);
